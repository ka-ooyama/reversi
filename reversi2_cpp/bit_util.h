...
uint64_t moveOrdering[8 * 8 - 4] = {   // ウサギ定石→ローズ
    ...
    59, 40, 31, 15, 16, 32, 53, 61, 13, 58, 57, 21, 38,
    5, 4, 23, 6, 39,
    50, 24, 49, 56, 60, 12, 48, 10, 52, 3, 2, 11, 54, 63, 55, 47, 62, 8, 9, 0, 1, 7, 14, 46
    //progress(0 %) evaluation_value(0)
    //37 43 34 29 20 42 19 45 44 51 22 26 25 17 41 18 33 30 59 40 31 15 16 32 53 61 13 58 57 21 38 5 4 23 6 39 50 24 49 56 60 12 48 10 52 3 2 11 54 63 55 47 62 8 9 0 1 7 14 46
};
#endif
